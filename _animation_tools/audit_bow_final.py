...
r=audit(items,bow=True,half=True);open(r'C:\Users\29\Desktop\3y\_animation_tools\bow_collision_final.json','w').write(json.dumps(r,indent=2));print('BOW_AUDIT',r)
