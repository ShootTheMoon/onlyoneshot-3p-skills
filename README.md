...
| Path | Contents |
|---|---|
| `Wakizashi_Skills/` | Wakizashi 3P skill clips (FBX) |
| `국궁_2026-08-26/` | Gukgung (Korean bow) 3P work |
| `Map/` | PreviewStage backdrop map, render/video pipeline |
| `OVDR_Import/` | Import-ready FBX rigs, stage parts, textures |
...
[`working-files` release](https://github.com/ShootTheMoon/onlyoneshot-3p-skills/releases/tag/working-files).
